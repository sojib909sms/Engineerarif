...
import { X, Download, Printer, ShieldCheck, Award, Briefcase, GraduationCap, Building2, Phone, Mail, MapPin, User, FileText, CheckCircle2, Globe, Laptop, ExternalLink, Calendar, Compass, Sparkles } from 'lucide-react';
...
`;
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/90 backdrop-blur-md flex items-center justify-center p-2 sm:p-4 md:p-6 overflow-y-auto animate-in fade-in duration-200">
      ...
      <div className="bg-white text-slate-900 rounded-2xl w-full max-w-4xl max-h-[94vh] flex flex-col shadow-2xl overflow-hidden relative border border-slate-300">
        
        {/* Header Bar */}
        <div className="bg-slate-900 text-white px-4 sm:px-6 py-3.5 border-b border-slate-800 flex items-center justify-between gap-2 shrink-0">
          ...
          <div className="flex items-center space-x-2 shrink-0">
            <button
              onClick={handlePrint}
              className="p-2 px-3 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-semibold flex items-center gap-1.5 transition-colors cursor-pointer border border-slate-700"
            ...
            <button
              ...
              className="p-2 px-3.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold flex items-center gap-1.5 shadow transition-colors cursor-pointer"
              title="Download CV as Text File"
            >
        ...
        <div ref={cvRef} className="p-4 sm:p-8 md:p-10 overflow-y-auto bg-slate-100 text-slate-800 font-sans print:p-0 print:bg-white print:overflow-visible">
          
          {/* Main CV Sheet (A4 Styled Canvas) */}
          <div className="bg-white rounded-2xl shadow-xl border border-slate-200/90 overflow-hidden print:border-none print:shadow-none print:rounded-none">
            
            {/* Executive Top Banner Header */}
            <div className="bg-gradient-to-r from-slate-950 via-slate-900 to-blue-950 text-white p-6 sm:p-8 border-b-4 border-amber-500 print:bg-slate-900 print:text-white">
              <div className="flex flex-col sm:flex-row items-center sm:items-start justify-between gap-6">
                ...
                <div className="shrink-0 flex flex-col items-center">
                  <div className="relative group">
                    <div className="w-32 h-40 sm:w-36 sm:h-44 rounded-xl overflow-hidden border-2 border-amber-400 shadow-2xl bg-slate-900 ring-4 ring-white/20 print:ring-0 flex items-center justify-center">
                      {cv.photoUrl ? (
                        <img
                          src={cv.photoUrl}
                          alt={cv.name}
            ...
            <div className="p-6 sm:p-8 md:p-10 space-y-7">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-3.5">
                  {cv.jobExperience.map((exp, idx) => (
                    <div key={idx} className="bg-white p-4 rounded-xl border-l-4 border-l-blue-700 border border-slate-200 shadow-sm space-y-2">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-white p-4 rounded-xl border-l-4 border-l-slate-700 border border-slate-200 shadow-sm space-y-2">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 border-b border-slate-100 pb-2">
                    <div>
